...
const RestaurantCard = ({cloudinaryImageId,name,cuisines,avgRating,areaName,sla,id})=>{
    return(
        <Link to={"/restaurants/"+id} className="card">
            ...
            <div className="rating-container">
                <svg width="20" height="20" viewBox="0 0 20 20" fill="none" role="img" aria-hidden="true">
                    ...
                    <defs><linearGradient id="StoreRating20_svg__paint0_linear_32982_71567" x1="10" y1="1" x2="10" y2="19" gradientUnits="userSpaceOnUse"><stop stopColor="#21973B"></stop><stop offset="1" stopColor="#128540"></stop></linearGradient>
                    </defs>
                </svg>
                <h3>{avgRating}</h3>
